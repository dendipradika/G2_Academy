...
const leftContent = <Text>     Hallo ...Hallo ...Hallo ...Hallo ...Hallo ...</Text>;
...
export default class Photo extends Component {
  ...
  getData = (page) => {
    ...
    fetch(`https://jsonplaceholder.typicode.com/albums/${JSON.stringify(albumId)}/photos?_page=${page}&_limit=15`)
    ...
    return(
      <SafeAreaView >
        <View style={styles.MainContainer}>
          <Text style={styles.button} onPress={() => navigation.navigate("Dashboard")} >Back to list Albums</Text>
