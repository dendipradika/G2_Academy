...
import { Image, Text, View, SafeAreaView, StyleSheet, ScrollView, TouchableOpacity } from "react-native";
...
export class Home extends Component {
  ...
  onAllowCamera(id, username) {
    this.manager
      .allowCamera(id)
      .then(val => {
        alert(`Success, ${username} allow to take picture`);
      })
      .catch(err => {
        ...
        <ScrollView>
            {
              ...
              this.props.listUser.map(usr => {
                return <Item
                  ...
                  onAllowCamera={() => this.onAllowCamera(usr.id, usr.username)}
                />
              })
            }
        </ScrollView> 
